...
def test_experience_score_partial_match():
    score = calculate_experience_match_score(candidate_years=2, required_years=4)

    assert score == 50.0


def test_experience_score_exact_match():
    score = calculate_experience_match_score(candidate_years=4, required_years=4)

    assert score == 100.0


def test_experience_score_is_capped_at_100():
    score = calculate_experience_match_score(candidate_years=8, required_years=4)

    assert score == 100.0


def test_experience_score_without_requirement():
    score = calculate_experience_match_score(candidate_years=3, required_years=None)
...
def test_analyze_experience_match():
    ...
    result = analyze_experience_match(job_description, resume_text)
...
def test_analyze_current_experience():
    ...
    result = analyze_experience_match(
        job_description, resume_text, current_date=date(2026, 12, 1)
    )
