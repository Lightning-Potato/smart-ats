...
def test_extract_required_years():
    text = "Candidates should have 3 years of experience in software development."

    assert extract_required_years(text) == 3


def test_extract_required_years_with_plus():
    text = "We require 5+ years of experience in backend engineering."
...
def test_extract_minimum_required_years():
    text = "A minimum of 2 years of relevant industry experience is required."
...
def test_no_explicit_experience_requirement():
    text = "Experience with Python and cloud technologies is preferred."
