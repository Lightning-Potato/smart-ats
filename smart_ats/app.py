...
if submitted:
    if job_description and resume_file:
        ...
        if resume_text:
            skill_analysis = analyze_skill_match(job_description, resume_text)

            experience_analysis = analyze_experience_match(job_description, resume_text)
            ...
            with st.spinner("Generating grounded AI insights..."):
                input_prompt = build_structured_analysis_prompt(
                    job_description, resume_text, findings
                )
