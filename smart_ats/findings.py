def calculate_experience_gap(
    ...
    return round(
        max(required_years - candidate_years, 0),
        2
    )
...
def build_deterministic_findings(
    ...
    required_years = experience_analysis[
        "required_years"
    ]

    candidate_years = experience_analysis[
        "candidate_years"
    ]
    ...
    return {
        "skills": {
            "matched_required": skill_analysis[
                "matched_required_skills"
            ],
            "missing_required": skill_analysis[
                "missing_required_skills"
            ],
            "matched_preferred": skill_analysis[
                "matched_preferred_skills"
            ],
            "missing_preferred": skill_analysis[
